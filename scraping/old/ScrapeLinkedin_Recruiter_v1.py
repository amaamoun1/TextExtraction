...
candidates = candidates[["doc_id_old", "doc_id_new", "candidate_firstname", "candidate_lastname", "undergrad_clean", "mba_clean", "college_raw", "college_potential"]]
...
path_out = "C:/Users/Asser.Maamoun/Documents/TextExtraction/output/scraping/v2"
...
with open(path_out + "/results.csv", 'a', newline='') as f:
    writer = csv.writer(f)
    # writer.writerow(["i", "start_time", "docid", "firstname", "lastname", "schools", "schools_type", "num_results", "is_namematch", "url"])
    for i in range(200):
        ...
        while (success==False) and (tries<3):
            ...
            try:
                ...
                if schools != "":
                    driver.find_element_by_xpath('//*[@id="keywords-input"]').send_keys(schools)
                else:
                    driver.find_element_by_xpath('//*[@id="keywords-input"]').send_keys("(ceo OR cfo)")
                ...
                if num_results=="":
                    ...
                    if num_results=="No candidates found":
                        writer.writerow([i, start_time, docid, firstname, lastname, schools, schools_type, 0,""])
                ...
                writer.writerow([i, start_time, docid, firstname, lastname, schools, schools_type, num_results, is_namematch, driver.current_url])
                time.sleep(random.uniform(1,2))
